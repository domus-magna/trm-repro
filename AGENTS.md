...
- Identifier hashes (2025-10-29): Legacy evaluation split hashes to `c364837393c2428e40c6116692fb1b66bf011108ec9930475df306cd779bbfd1`; legacy test split hashes to `9af3f07ab5c05320e2da99c85ad76086f7cbabe2159b5cf694da01aa7e33546f`. Treat any deviation as a guard failure and halt the run.
- Latest Kaggle weights export (step 249 575) lives at `seconds0/trm-arc2-weights-trm-arc2-8gpu-step249575` (private). Evaluation still shows duplicate attempts (ARC pass@1 ≈ 0.004), so hold submissions until resume accuracy recovers.
- Kaggle repo snapshot `seconds0/trm-repo-clean` refreshed (latest version 2025-10-30 12:03 UTC) with evaluator diagnostics; duplicate attempts remain at 172/172 (evaluation) and 259/259 (test) despite the ranking fix.
